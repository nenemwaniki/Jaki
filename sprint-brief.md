...
- **Files to touch:** `capacitor.config.ts` (new), `android/` folder (generated by Capacitor — avoid manual edits unless required; prefer `npx cap sync android` and document any changes you do make)
