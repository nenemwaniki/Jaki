...
insert into routine_items (id, patient_id, emoji, title, note, time, dur, state, sort_order, routine_date) values
  ('d1000000-0000-0000-0000-000000000001', patient_uid, '🌅', 'Morning Routine', 'Shower, brush teeth, get dressed', '7:30',  30, 'done',    1, current_date),
  ('d1000000-0000-0000-0000-000000000002', patient_uid, '🥣', 'Breakfast',        'Eat in the kitchen',               '8:15',  30, 'done',    2, current_date),
  ('d1000000-0000-0000-0000-000000000003', patient_uid, '🎨', 'Creative Time',    'Drawing or painting activity',     '10:00', 45, 'current', 3, current_date),
  ('d1000000-0000-0000-0000-000000000004', patient_uid, '🚶', 'Walk Outside',     '15 min walk around the compound',  '11:00', 15, 'next',    4, current_date),
  ('d1000000-0000-0000-0000-000000000005', patient_uid, '🍽', 'Lunch',            'Eat in the kitchen with Jaki',     '12:30', 45, 'next',    5, current_date),
  ('d1000000-0000-0000-0000-000000000006', patient_uid, '📺', 'YouTube Time',     'Watch favourite channels',         '13:30', 60, 'next',    6, current_date),
  ('d1000000-0000-0000-0000-000000000007', patient_uid, '🧩', 'Learning',         'Puzzles or number games',          '15:00', 45, 'next',    7, current_date),
  ('d1000000-0000-0000-0000-000000000008', patient_uid, '🌙', 'Evening Routine',  'Wind down, prepare for bed',       '19:00', 60, 'next',    8, current_date)
on conflict (id) do nothing;
...
insert into aac_cards (id, patient_id, category, text, emoji, sort_order) values
  -- urgent
  ('e1000000-0000-0000-0000-000000000001', patient_uid, 'urgent', 'I don''t feel well', '🤒', 1),
  ('e1000000-0000-0000-0000-000000000002', patient_uid, 'urgent', 'I need help',        '😰', 2),
  ('e1000000-0000-0000-0000-000000000003', patient_uid, 'urgent', 'Pain',               '😣', 3),
  -- daily
  ('e1000000-0000-0000-0000-000000000004', patient_uid, 'daily',  'I''m hungry',        '🍽', 1),
  ('e1000000-0000-0000-0000-000000000005', patient_uid, 'daily',  'I''m okay',          '😊', 2),
  ('e1000000-0000-0000-0000-000000000006', patient_uid, 'daily',  'I want to rest',     '😴', 3),
  ('e1000000-0000-0000-0000-000000000007', patient_uid, 'daily',  'I want to go home',  '🏠', 4),
  -- social
  ('e1000000-0000-0000-0000-000000000008', patient_uid, 'social', 'Hi! How are you?',   '👋', 1),
  ('e1000000-0000-0000-0000-000000000009', patient_uid, 'social', 'Thank you',          '🙏', 2),
  ('e1000000-0000-0000-0000-000000000010', patient_uid, 'social', 'That was fun!',      '😄', 3),
  ('e1000000-0000-0000-0000-000000000011', patient_uid, 'social', 'I miss you',         '🤗', 4)
on conflict (id) do nothing;
...
insert into zones (id, patient_id, name, lat, lng, radius, color, active, inside) values
  ('f1000000-0000-0000-0000-000000000001', patient_uid, 'Home',             -1.2921, 36.8219, 120, '#87A878', true,  true),
  ('f2000000-0000-0000-0000-000000000002', patient_uid, 'Pool Centre',      -1.2934, 36.8201, 80,  '#6F8FA8', true,  false),
  ('f3000000-0000-0000-0000-000000000003', patient_uid, 'Therapist clinic', -1.2890, 36.8250, 60,  '#8A6E8C', false, false)
on conflict (id) do nothing;
